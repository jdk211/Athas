	...
	BOOL useDepthAndStencil )
{
	...
	Device->GetRenderTarget(this->stageNum, &pDeviceTargetSurface);				//현재 Device 의 0 번 랜더 TargetSurface 를 기억
	Device->GetDepthStencilSurface(&pDeviceDepthAndStencilSurface);	//현재 Device 의 스텐실 버퍼와 뎁스퍼퍼 표면기억
