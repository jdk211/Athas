...
private:
	...
	cQuadParticle*			m_pPaticles;				//파티클 배열
	cQuadParticle**			m_pSortArray;				//파티클 소트용 Array
...
public:
	...
	void Update(float timeDelta);			//BaseObject 가 Update 때 실행....
	void Render(bool additiveBlend = false);
